...
@section("content")
    ...
    <div class="mt-3">
        ...
        <label class="form-label">
            Done at:
            <input type="text" class="form-control-plaintext" value="{{ $todo->done_at !== null ? $todo->done_at->format("Y/m/d H:i:s") : "NULL" }}" readonly>
        </label>
        <label class="form-label">
            Created at:
            <input type="text" class="form-control-plaintext" value="{{ $todo->created_at->format("Y/m/d H:i:s") }}" readonly>
        </label>
        <label class="form-label">
            Updated at:
            <input type="text" class="form-control-plaintext" value="{{ $todo->updated_at->format("Y/m/d H:i:s") }}" readonly>
        </label>
    </div>
    <div class="mt-3">
